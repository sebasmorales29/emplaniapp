...
{
    public interface IRegistrarEventoHistorialLN
    {
        ...
        bool ValidarDatosEvento(int idEmpleado, string nombreEvento, string descripcionEvento);
        
        string ObtenerIPUsuario();
    }
}
